import type { RLCParams, TimePoint, CircuitType, ComponentFlags } from './types'
import { calc } from './rlc-engine'

const CYCLES  = 2
const SAMPLES = 200

export function calcTimeDomain(type: CircuitType, params: RLCParams, flags: ComponentFlags = { hasL: true, hasC: true }): TimePoint[] {
  const { Vs, f } = params
