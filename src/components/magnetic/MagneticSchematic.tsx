...
export function MagneticSchematic() {
  ...
  useEffect(() => {
    ...
    ctx.beginPath();
    ctx.moveTo(xVs, topY);
    ctx.lineTo(xVs, midY - 16);
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(xVs, midY + 16);
    ctx.lineTo(xVs, botY);
    ctx.stroke();
    ...
    ctx.beginPath();
    ctx.moveTo(xEnd, topY);
    ctx.lineTo(xEnd, midY - 18);
    ctx.stroke();
    vertResistor(ctx, xEnd, midY, "R₂", isDark, rColor, labelC, resistorSymbol);
    ctx.strokeStyle = wireS;
    ctx.lineWidth = 2;
    ctx.beginPath();
    ctx.moveTo(xEnd, midY + 18);
    ctx.lineTo(xEnd, botY);
    ctx.stroke();
    // Bottom rail
    ctx.beginPath();
    ctx.moveTo(xEnd, botY);
    ctx.lineTo(xL2, botY);
    ctx.stroke();
    ...
    ctx.setLineDash([6, 4]);
    ctx.beginPath();
    ctx.moveTo(263, topY - 10);
    ctx.lineTo(263, botY + 10);
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(317, topY - 10);
    ctx.lineTo(317, botY + 10);
    ctx.stroke();
    ctx.setLineDash([]);
