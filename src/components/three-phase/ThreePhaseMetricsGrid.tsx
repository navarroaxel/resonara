...
export function ThreePhaseMetricsGrid() {
  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <MetricCard label={t(lang, 'phaseCurrent')}  value={fmt(I_ph, 3)}  unit="A"   color="text-teal-600 dark:text-teal-400"    />
      <MetricCard label={t(lang, 'lineCurrent')}   value={fmt(I_L, 3)}   unit="A"   color="text-teal-600 dark:text-teal-400"    />
      ...
      <MetricCard label={t(lang, 'phaseVoltage')}  value={fmt(V_ph, 1)}  unit="V"   />
      ...
      <MetricCard label={t(lang, 'reactivePower')} value={fmt(Qr)}       unit="VAR" color="text-orange-500 dark:text-orange-400" />
