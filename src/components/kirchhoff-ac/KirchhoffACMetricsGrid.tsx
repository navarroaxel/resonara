  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <MetricCard
          label={t(lang, "kacZm")}
          value={`${fmt(Zm_re, 2)} + j${fmt(Zm_im, 2)}`}
          unit="Ω"
        />
        <MetricCard
          label={t(lang, "kacZc")}
      ...
      <div className="grid grid-cols-3 gap-2">
        <MetricCard
          label={t(lang, "kacActivePower")}
          value={fmt(P, 2)}
          unit="W"
          color="text-green-600 dark:text-green-400"
        />
        <MetricCard
          label={t(lang, "kacReactivePower")}
          value={fmt(Q, 2)}
          unit="VAR"
          color="text-orange-600 dark:text-orange-400"
        />
        <MetricCard
          label={t(lang, "kacApparentPower")}
          value={fmt(S, 2)}
          unit="VA"
        />
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <MetricCard
          label={t(lang, "kacMotorActivePower")}
          value={fmt(P_m, 2)}
          unit="W"
          color="text-green-600 dark:text-green-400"
        />
        <MetricCard
          label={t(lang, "kacMotorReactivePower")}
          value={fmt(Q_m, 2)}
          unit="VAR"
          color="text-orange-600 dark:text-orange-400"
        />
        <MetricCard
          label={t(lang, "kacMotorApparentPower")}
          value={fmt(S_m, 2)}
          unit="VA"
        />
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <MetricCard
          label={t(lang, "kacLoadPower")}
          value={fmt(P_R, 2)}
          unit="W"
          color="text-green-600 dark:text-green-400"
        />
        <MetricCard
          label={t(lang, "kacLinePower")}
          value={fmt(P_R1, 2)}
          unit="W"
        />
        <MetricCard
          label={t(lang, "kacMotorEfficiency")}
          value={fmt(eta_m * 100, 2)}
          unit="%"
          color={
            eta_m >= 0.9
              ? "text-green-600 dark:text-green-400"
