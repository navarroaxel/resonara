...
export function MetricsGrid() {
  ...
  const { state: { lang, unitNotation } } = useUI()
  ...
  if (polyMode && polyResults) {
    ...
    return (
      <div className="grid grid-cols-3 gap-2">
        ...
        <MetricCard label={t(lang, 'iRms')}          {...u(I_rms, 'A', unitNotation, 3)}  color="text-teal-600 dark:text-teal-400"    />
        <MetricCard label={t(lang, 'resFreq')}       value={fmt(fr, 1)}    unit="Hz"  />
        <MetricCard label={t(lang, 'impedance')}     {...u(Z, 'Ω', unitNotation)}      color="text-blue-600 dark:text-blue-400"    />
        <MetricCard label={t(lang, 'xl')}            {...u(XL, 'Ω', unitNotation)}     />
        <MetricCard label={t(lang, 'xc')}            {...u(XC, 'Ω', unitNotation)}     />
        <MetricCard label={t(lang, 'activePower')}   {...u(P_total, 'W', unitNotation)} color="text-green-600 dark:text-green-400"  />
        <MetricCard label={t(lang, 'reactivePower')} {...u(Qp_total, 'VAR', unitNotation)} color="text-orange-500 dark:text-orange-400" />
        <MetricCard label={t(lang, 'apparentPower')} {...u(S_total, 'VA', unitNotation)}  color="text-blue-600 dark:text-blue-400"    />
  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      <MetricCard label={t(lang, 'phaseAngle')}    value={fmt(phi, 1)} unit="°"   color="text-violet-600 dark:text-violet-400" />
      <MetricCard label={t(lang, 'current')}       {...u(I, 'A', unitNotation, 3)}  color="text-teal-600 dark:text-teal-400"    />
      <MetricCard label={t(lang, 'resFreq')}       value={fmt(fr, 1)}  unit="Hz"  />
      <MetricCard label={t(lang, 'impedance')}     {...u(Z, 'Ω', unitNotation)}   color="text-blue-600 dark:text-blue-400"    />
      <MetricCard label={t(lang, 'xl')}            {...u(XL, 'Ω', unitNotation)}  />
      <MetricCard label={t(lang, 'xc')}            {...u(XC, 'Ω', unitNotation)}  />
      <MetricCard label={t(lang, 'activePower')}   {...u(P, 'W', unitNotation)}   color="text-green-600 dark:text-green-400"  />
      <MetricCard label={t(lang, 'reactivePower')} {...u(Qp, 'VAR', unitNotation)} color="text-orange-500 dark:text-orange-400" />
      <MetricCard label={t(lang, 'apparentPower')} {...u(S, 'VA', unitNotation)}  color="text-blue-600 dark:text-blue-400"    />
      <MetricCard label={t(lang, 'qFactor')}       value={fmt(Q)}                 />
