...
export function RCDCFooter() {
  const {
    state: { lang },
  } = useUI();
  return (
    <footer className="mt-4 border-t border-neutral-200 px-6 py-6 text-sm text-neutral-500 dark:border-neutral-800 dark:text-neutral-400">
      <p className="mb-3">
        {t(lang, "footerCredit")}{" "}
