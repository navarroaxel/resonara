      ...
      <div className="mb-1.5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          {flagKey && (
            <button
              onClick={() =>
                dispatch({ type: "SET_FLAG", key: flagKey, value: !enabled })
              }
          ...
          {polarityKey && (
            <button
              ...
              title="Flip polarity"
              className={`flex h-7 w-12 flex-shrink-0 items-center justify-center rounded border transition-colors ${
                polarity
            ...
            <div className="space-y-5">
              {MESH3_PARAMS.map((config) => (
                <ParamRow
                  ...
                  enabled={config.flagKey ? flags[config.flagKey] : true}
                  polarity={
                    config.polarityKey ? flags[config.polarityKey] : true
                  }
                  lang={lang}
                  dispatch={dispatch}
                />
