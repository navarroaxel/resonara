...
export function DCMetricsGrid() {
  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      <MetricCard
        label={t(lang, "dcMeshCurrent1")}
        value={fmt(I1, 4)}
        unit="A"
        color="text-violet-600 dark:text-violet-400"
      />
      <MetricCard
        label={t(lang, "dcMeshCurrent2")}
        value={fmt(I2, 4)}
        unit="A"
      ...
      {mesh3 ? (
        ...
        <MetricCard
          label={t(lang, "dcVoltageR1")}
          value={fmt(VR1, 3)}
          unit="V"
        />
      )}
      <MetricCard
        label={t(lang, "dcBranchCurrentR2")}
        value={fmt(IR2, 4)}
        unit="A"
      ...
      {mesh3 ? (
        <MetricCard
          label={t(lang, "dcBranchCurrentR4")}
          value={fmt(IR4, 4)}
          unit="A"
          color="text-blue-600 dark:text-blue-400"
        />
      ...
      <MetricCard
        label={t(lang, "dcPowerV1")}
        value={fmt(PV1, 3)}
        unit="W"
        color="text-violet-600 dark:text-violet-400"
      />
      <MetricCard
        label={t(lang, "dcPowerV2")}
        value={fmt(PV2, 3)}
        unit="W"
        color="text-teal-600 dark:text-teal-400"
      />
      {mesh3 ? (
        ...
        <MetricCard
          label={t(lang, "dcNodeVoltageA")}
          value={fmt(results.VA, 3)}
          unit="V"
        />
      )}
      <MetricCard
        label={t(lang, "dcPowerR1")}
        value={fmt(PR1, 3)}
        unit="W"
        color="text-green-600 dark:text-green-400"
      />
      <MetricCard
        label={t(lang, "dcPowerR3")}
        value={fmt(PR3, 3)}
        unit="W"
        color="text-green-600 dark:text-green-400"
      />
