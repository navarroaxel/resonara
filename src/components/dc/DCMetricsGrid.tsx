...
export function DCMetricsGrid() {
  ...
  const { I1, I2, IR2, VR1, VR2, VR3, VA, IR1, IR3 } = results
  const PR1 = VR1 * IR1
  const PR2 = Math.abs(VR2 * IR2)
  const PR3 = VR3 * IR3
  ...
  return (
    <div className="grid grid-cols-3 gap-2">
      ...
      <MetricCard label={t(lang, 'dcNodeVoltageA')}   value={fmt(VA, 3)}  unit="V"  color="text-amber-600 dark:text-amber-400"   />
